...
export default function WhyAmruthdhan() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="mt-6 text-gray-700 leading-relaxed">
            Amruthdhan is a unique platform that combines pure, organic dairy
            production with a dependable earning opportunity. By choosing
            Amruthdhan, you become part of a system that delivers healthy milk
          ...
          <p className="mt-4 text-gray-700 leading-relaxed">
            ...
            income for partners. With Amruthdhan, you are not just investing in
